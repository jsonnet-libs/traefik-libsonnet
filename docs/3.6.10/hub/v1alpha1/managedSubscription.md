---
permalink: /3.6.10/hub/v1alpha1/managedSubscription/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withManagedApplications(managedApplications)`](#fn-specwithmanagedapplications)
  * [`fn withManagedApplicationsMixin(managedApplications)`](#fn-specwithmanagedapplicationsmixin)
  ...
  * [`obj spec.managedApplications`](#obj-specmanagedapplications)
    * [`fn withName(name)`](#fn-specmanagedapplicationswithname)
...
### fn spec.withManagedApplications

```ts
withManagedApplications(managedApplications)
```
...
### fn spec.withManagedApplicationsMixin

```ts
withManagedApplicationsMixin(managedApplications)
```
...
## obj spec.managedApplications

"ManagedApplications references the ManagedApplications that will gain access to the specified APIs.\nMultiple ManagedSubscriptions can select the same ManagedApplication."

### fn spec.managedApplications.withName
