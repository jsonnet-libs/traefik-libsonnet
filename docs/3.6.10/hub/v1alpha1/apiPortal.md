---
permalink: /3.6.10/hub/v1alpha1/apiPortal/
---

# hub.v1alpha1.apiPortal
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withTrustedUrls(trustedUrls)`](#fn-specwithtrustedurls)
  * [`fn withTrustedUrlsMixin(trustedUrls)`](#fn-specwithtrustedurlsmixin)
  * [`obj spec.auth`](#obj-specauth)
    * [`fn withName(name)`](#fn-specauthwithname)
  * [`obj spec.ui`](#obj-specui)
    * [`fn withLogoUrl(logoUrl)`](#fn-specuiwithlogourl)
...
new returns an instance of APIPortal
...
### fn spec.withTrustedUrls

```ts
withTrustedUrls(trustedUrls)
```

"TrustedURLs are the urls that are trusted by the OAuth 2.0 authorization server."

### fn spec.withTrustedUrlsMixin

```ts
withTrustedUrlsMixin(trustedUrls)
```
