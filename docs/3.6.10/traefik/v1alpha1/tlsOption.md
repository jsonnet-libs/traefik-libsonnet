---
permalink: /3.6.10/traefik/v1alpha1/tlsOption/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withDisableSessionTickets(disableSessionTickets)`](#fn-specwithdisablesessiontickets)
...
### fn spec.withDisableSessionTickets

```ts
withDisableSessionTickets(disableSessionTickets)
```
