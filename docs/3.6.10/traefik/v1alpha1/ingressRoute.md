---
permalink: /3.6.10/traefik/v1alpha1/ingressRoute/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.routes`](#obj-specroutes)
    ...
    * [`obj spec.routes.observability`](#obj-specroutesobservability)
      ...
      * [`fn withTraceVerbosity(traceVerbosity)`](#fn-specroutesobservabilitywithtraceverbosity)
    ...
    * [`obj spec.routes.services`](#obj-specroutesservices)
      ...
      * [`obj spec.routes.services.healthCheck`](#obj-specroutesserviceshealthcheck)
        ...
        * [`fn withUnhealthyInterval(unhealthyInterval)`](#fn-specroutesserviceshealthcheckwithunhealthyinterval)
      * [`obj spec.routes.services.passiveHealthCheck`](#obj-specroutesservicespassivehealthcheck)
        * [`fn withFailureWindow(failureWindow)`](#fn-specroutesservicespassivehealthcheckwithfailurewindow)
        * [`fn withMaxFailedAttempts(maxFailedAttempts)`](#fn-specroutesservicespassivehealthcheckwithmaxfailedattempts)
      ...
      * [`obj spec.routes.services.sticky`](#obj-specroutesservicessticky)
        * [`obj spec.routes.services.sticky.cookie`](#obj-specroutesservicesstickycookie)
          * [`fn withDomain(domain)`](#fn-specroutesservicesstickycookiewithdomain)
...
### fn spec.routes.observability.withTraceVerbosity

```ts
withTraceVerbosity(traceVerbosity)
```
...
### fn spec.routes.services.healthCheck.withUnhealthyInterval
...
## obj spec.routes.services.passiveHealthCheck

"PassiveHealthCheck defines passive health checks for ExternalName services."

### fn spec.routes.services.passiveHealthCheck.withFailureWindow
...
### fn spec.routes.services.passiveHealthCheck.withMaxFailedAttempts
...
### fn spec.routes.services.sticky.cookie.withDomain
