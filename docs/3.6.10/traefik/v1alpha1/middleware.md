---
permalink: /3.6.10/traefik/v1alpha1/middleware/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.errors`](#obj-specerrors)
    ...
    * [`fn withStatusRewrites(statusRewrites)`](#fn-specerrorswithstatusrewrites)
    * [`fn withStatusRewritesMixin(statusRewrites)`](#fn-specerrorswithstatusrewritesmixin)
    * [`obj spec.errors.service`](#obj-specerrorsservice)
      ...
      * [`obj spec.errors.service.healthCheck`](#obj-specerrorsservicehealthcheck)
        ...
        * [`fn withUnhealthyInterval(unhealthyInterval)`](#fn-specerrorsservicehealthcheckwithunhealthyinterval)
      * [`obj spec.errors.service.passiveHealthCheck`](#obj-specerrorsservicepassivehealthcheck)
        * [`fn withFailureWindow(failureWindow)`](#fn-specerrorsservicepassivehealthcheckwithfailurewindow)
        * [`fn withMaxFailedAttempts(maxFailedAttempts)`](#fn-specerrorsservicepassivehealthcheckwithmaxfailedattempts)
      ...
      * [`obj spec.errors.service.sticky`](#obj-specerrorsservicesticky)
        * [`obj spec.errors.service.sticky.cookie`](#obj-specerrorsservicestickycookie)
          * [`fn withDomain(domain)`](#fn-specerrorsservicestickycookiewithdomain)
  ...
  * [`obj spec.forwardAuth`](#obj-specforwardauth)
    ...
    * [`fn withMaxResponseBodySize(maxResponseBodySize)`](#fn-specforwardauthwithmaxresponsebodysize)
    * [`fn withPreserveLocationHeader(preserveLocationHeader)`](#fn-specforwardauthwithpreservelocationheader)
    * [`fn withPreserveRequestMethod(preserveRequestMethod)`](#fn-specforwardauthwithpreserverequestmethod)
  ...
  * [`obj spec.rateLimit`](#obj-specratelimit)
    ...
    * [`obj spec.rateLimit.redis`](#obj-specratelimitredis)
      * [`fn withDb(db)`](#fn-specratelimitrediswithdb)
      * [`fn withDialTimeout(dialTimeout)`](#fn-specratelimitrediswithdialtimeout)
      * [`fn withEndpoints(endpoints)`](#fn-specratelimitrediswithendpoints)
      * [`fn withEndpointsMixin(endpoints)`](#fn-specratelimitrediswithendpointsmixin)
      * [`fn withMaxActiveConns(maxActiveConns)`](#fn-specratelimitrediswithmaxactiveconns)
      * [`fn withMinIdleConns(minIdleConns)`](#fn-specratelimitrediswithminidleconns)
      * [`fn withPoolSize(poolSize)`](#fn-specratelimitrediswithpoolsize)
      * [`fn withReadTimeout(readTimeout)`](#fn-specratelimitrediswithreadtimeout)
      * [`fn withSecret(secret)`](#fn-specratelimitrediswithsecret)
      * [`fn withWriteTimeout(writeTimeout)`](#fn-specratelimitrediswithwritetimeout)
      * [`obj spec.rateLimit.redis.tls`](#obj-specratelimitredistls)
        * [`fn withCaSecret(caSecret)`](#fn-specratelimitredistlswithcasecret)
        * [`fn withCertSecret(certSecret)`](#fn-specratelimitredistlswithcertsecret)
        * [`fn withInsecureSkipVerify(insecureSkipVerify)`](#fn-specratelimitredistlswithinsecureskipverify)
...
### fn spec.errors.withStatusRewrites

```ts
withStatusRewrites(statusRewrites)
```
...
### fn spec.errors.withStatusRewritesMixin

```ts
withStatusRewritesMixin(statusRewrites)
```
...
### fn spec.errors.service.healthCheck.withUnhealthyInterval
...
## obj spec.errors.service.passiveHealthCheck

"PassiveHealthCheck defines passive health checks for ExternalName services."

### fn spec.errors.service.passiveHealthCheck.withFailureWindow
...
### fn spec.errors.service.passiveHealthCheck.withMaxFailedAttempts
...
### fn spec.errors.service.sticky.cookie.withDomain
...
### fn spec.forwardAuth.withMaxResponseBodySize

```ts
withMaxResponseBodySize(maxResponseBodySize)
```
...
### fn spec.forwardAuth.withPreserveRequestMethod

```ts
withPreserveRequestMethod(preserveRequestMethod)
```
...
### fn spec.rateLimit.redis.withDialTimeout
...
### fn spec.rateLimit.redis.withEndpoints
...
### fn spec.rateLimit.redis.withEndpointsMixin
...
### fn spec.rateLimit.redis.withMaxActiveConns

```ts
withMaxActiveConns(maxActiveConns)
```
...
### fn spec.rateLimit.redis.withMinIdleConns
...
### fn spec.rateLimit.redis.withPoolSize
...
### fn spec.rateLimit.redis.withReadTimeout
...
### fn spec.rateLimit.redis.withSecret
...
### fn spec.rateLimit.redis.withWriteTimeout
...
### fn spec.rateLimit.redis.tls.withCaSecret
...
### fn spec.rateLimit.redis.tls.withCertSecret
...
### fn spec.rateLimit.redis.tls.withInsecureSkipVerify
