---
permalink: /3.6.10/traefik/v1alpha1/serversTransport/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withRootCAs(rootCAs)`](#fn-specwithrootcas)
  * [`fn withRootCAsMixin(rootCAs)`](#fn-specwithrootcasmixin)
  ...
  * [`obj spec.rootCAs`](#obj-specrootcas)
    * [`fn withConfigMap(configMap)`](#fn-specrootcaswithconfigmap)
    * [`fn withSecret(secret)`](#fn-specrootcaswithsecret)
  * [`obj spec.spiffe`](#obj-specspiffe)
    * [`fn withIds(ids)`](#fn-specspiffewithids)
    * [`fn withIdsMixin(ids)`](#fn-specspiffewithidsmixin)
    * [`fn withTrustDomain(trustDomain)`](#fn-specspiffewithtrustdomain)
...
### fn spec.spiffe.withTrustDomain
